...
export type StatePersistenceShape = {
...
export class StatePersistence extends ServiceMap.Service<StatePersistence, StatePersistenceShape>()(
  "StatePersistence",
) {}
...
export const StatePersistenceLayer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    } satisfies StatePersistenceShape;
  }),
);
