...
export const resolveReferencedMessage = (message: Message): Effect.Effect<Message | null, never> => {
...
export const collectAttachmentMessages = (message: Message): Effect.Effect<ReadonlyArray<Message>, never> =>
